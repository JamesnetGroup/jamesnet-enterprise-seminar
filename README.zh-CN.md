...
# Jamesnet 企业研讨会系列 [![English](https://img.shields.io/badge/docs-English-blue.svg)](README.md) [![中文](https://img.shields.io/badge/docs-中文-red.svg)](README.zh-CN.md) [![한국어](https://img.shields.io/badge/docs-한국어-green.svg)](README.ko.md)
...
- 主题：从 WPF 基础到高级主题
- 内容：应用程序、窗口、StackPanel、Grid、Border、Button 等各种控件、数据绑定、自定义控件
- [企业研讨会介绍](20241017.zh-CN.md)
